...
const Main = () => {
  ...
  useEffect(() => {
    ...
    const retriveOrStore = async () => {
      try {
        const [launchedValue, Token, LoginedValue] = await Promise.all([AsyncStorage.getItem('launched'), AsyncStorage.getItem('token'), AsyncStorage.getItem('logined')]);
          ...
          if (LoginedValue === null || Token === null) {
            ...
            try {
              const res = await fetch(
                `${API_BASE_URL}/verify_user_token`,
                {
                  method: 'POST',
  ...
  return (
    <RecordProvider>
      <MetronomeProvider>
        <AllLessonsProvider>
        <StatusBar backgroundColor="#F5D17D" barStyle="dark-content" />
        <NavigationContainer>
          <Stack.Navigator initialRouteName={initialRouteName}>
            ...
            <Stack.Screen name="All Levels Screen" component={HomeScreen} options={{ headerShown: false }} />
            <Stack.Screen name="Lesson with Metronome" component={LessonWithMetronome} options={{ headerShown: false }} />
            <Stack.Screen name="FeedbackScreen" component={Feedback} options={{ headerShown: false }} />
            <Stack.Screen name="Lesson Screen" component={LessonScreen} options={{ headerShown: false }} />
            <Stack.Screen name="Unorganized Lessons" component={UnorganizedLessons} />
            <Stack.Screen name="Lesson Details" component={LessonDetails} />
            <Stack.Screen name="Learn Screen" component={LessonWithoutMetronome} options={{ headerShown: false }} />
            ...
            <Stack.Screen name="Purchase" component={withIAPContext(Purchase)} options={{ headerShown: false }} />
            <Stack.Screen name="Purchase Status" component={PurchaseStatus} options={{ headerShown: false }} />
            <Stack.Screen name="Admin" component={Admin} />
            <Stack.Screen name="WebSocket" component={WebSocket} options={{ headerShown: false }} />
