...
import { View, Text, StyleSheet, TouchableOpacity, Modal, SafeAreaView, StatusBar, Alert, Linking, BackHandler } from 'react-native';
...
const LessonWithoutMetronome = ({route,navigation}) => {
    ...
    const { initAudioRecord, startRecord, handleStopRecording, audioFile, loaded, setLoaded, recording, hasRecorded, setRecording, setAudioFile, setHasRecorded, setRecordDefault } = useRecord();
      ...
      const handleUpload = async () => {
        ...
        try {
          const res = await fetch(
            `${API_BASE_URL}/single_syllable_predict`,
            {
              method: 'POST',
              body: bodyContent,
            },
