...
import { ScrollView, StyleSheet, Text, View, Platform, TouchableOpacity, SafeAreaView, ActivityIndicator, } from "react-native";
...
const subscriptionSkus = Platform.select({
  ...
  android: ["takadimi_199_1m", "takadimi_1999_1y_2m0"],
});
              ...
              return (
                <View style={styles.box} key={index}>
                  ...
                  {subscription?.introductoryPriceSubscriptionPeriodIOS && (
                    <Text>
                      Free for 2{" "}
                      {subscription?.introductoryPriceSubscriptionPeriodIOS}S
                    </Text>
                  )}
